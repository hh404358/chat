...
import com.hahaha.platform.modules.chat.mapper.ChatGroupMapper;
...
public class ChatGroupServiceImpl extends BaseServiceImpl<ChatGroup> implements ChatGroupService {
    ...
    public void setBaseDao() {
        super.setBaseDao(chatGroupMapper);
    }

    @Override
    public List<ChatGroup> queryList(ChatGroup t) {
        List<ChatGroup> dataList = chatGroupMapper.queryList(t);
        return dataList;
    }
    ...
    public List<PushParamVo> queryFriendPushFrom(ChatMsg chatMsg) {
        Long userId = ShiroUtils.getUserId();
        List<PushParamVo> paramList = chatGroupMapper.queryFriendPushFrom(chatMsg.getToId(), userId);
