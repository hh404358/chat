...
import com.hahaha.platform.common.redis.GeoHashUtils;
import com.hahaha.platform.common.redis.RedisUtils;
import com.hahaha.platform.common.shiro.Md5Utils;
...
public class ChatUserServiceImpl extends BaseServiceImpl<ChatUser> implements ChatUserService {
    ...
    public void setBaseDao() {
        super.setBaseDao(chatUserMapper);
    }

    @Override
    public List<ChatUser> queryList(ChatUser t) {
        List<ChatUser> dataList = chatUserMapper.queryList(t);
        return dataList;
    }
